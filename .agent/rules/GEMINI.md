...
5.  **Diagnóstico**: Se sentir que o ambiente está instável, rode `ctx_doctor`.
...
### Regras de Memória
- **JOURNAL.md**: Diário de decisões e progresso do projeto.
- **MEMORIA.md**: Se necessário para persistência de contexto longo.
