...
FASE C: Embeddings, Trackers & Operação (M5, M6, M7)
   │
   ├─ M5: Embeddings Vetoriais (Pós-MVP) ✅ 2026-03-09
   ...
   │    Pendente: cold-start via snapshot → agendado M6
   │
   ├─ M6: Maturação e Operação ✅ 2026-03-09
   ...
   │
   └─ M7: Trackers e Expansão ✅ 2026-03-09
...
FASE D: Git Journal & Validação (M8) ✅ 2026-03-10
   ...
   └─ M8: Git Journal Append (T4.4 Extension) ✅
        ...
        CLI `pks hook-post-commit` extendido via `git_journal_append.rs` (zero mudanças no daemon) ✅
        Variáveis de ambiente documentadas em .env.example ✅

FASE E: Instalador One-Click (M9) ✅ 2026-03-10
   │
   └─ M9: Instalador One-Click (Antigravity) ✅
        Detecção automática de OS (macOS/Linux vs Windows) ✅
        Instalação idempotente: Homebrew/Winget + Rust + Git + gh + Ollama ✅
        Pull automático do modelo `nomic-embed-text` ✅
        Workflow Antigravity `/pks-install` (`.agent/workflows/pks-install.md`) ✅
        Verificação pós-instalação: rustc, git, gh, ollama list ✅
```
